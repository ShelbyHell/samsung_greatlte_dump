#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/platform/11120000.ufs/by-name/RECOVERY:43866400:1aa81f67a3dd01a36eefe42d01c4383d3af76d86; then
  applypatch EMMC:/dev/block/platform/11120000.ufs/by-name/BOOT:37439776:b4653e1db300c76475a622e3513d9a728216238d EMMC:/dev/block/platform/11120000.ufs/by-name/RECOVERY 1aa81f67a3dd01a36eefe42d01c4383d3af76d86 43866400 b4653e1db300c76475a622e3513d9a728216238d:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || echo 454 > /cache/fota/fota.status
else
